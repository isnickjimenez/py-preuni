<x-form-layout>
    <div class="flex items-center justify-center min-h-screen w-full max-w-3xl m-auto">
        <div
            ...
            <h1 class="tracking-wide uppercase text-2xl font-bold text-blue-900 mt-8 mb-10 text-center">
                Matricula 2025-II
            </h1>
            <form action="{{ route('api.invoke') }}" method="POST">
                @csrf
                <label for="dni_S"
                    class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-16 text-center">
                ...
                <div class="flex flex-col items-center justify-center space-y-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <input
                            ...
                            type="text" id="dni_S" name="dni_S" value="{{ old('dni_S') }}"
                            placeholder="DNI*" />
                    </div>
                    <button type="submit"
